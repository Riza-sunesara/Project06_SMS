...
class Student {
    ...
    c_name = "jdjhfjdas";
    coursefees = 121;
    constructor(sname, s_fname, dob, balance, course) {
        this.sname = sname;
...
async function balance_check(stud_bal) {
...
async function Std_Tasks(stu, stud_bal) {
    if (stu) {
...
start();
//issue is in payfees and balance check
